...
. Iterate through the matrix and if an element is zero, set the corresponding element in the   row and   column to zero.
. Iterate through the matrix again, excluding the first row and first column. If an element in the first row or first column is zero, set the current element to zero.
. Finally, based on the values in firstRowZero and firstColZero, set the first row and first column to zero if needed.
*/
