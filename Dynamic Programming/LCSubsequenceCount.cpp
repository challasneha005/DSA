...
int main(){
    ...
    cout << "LCSubsequence length = " << lcs(n-1, m-1, s1, s2) << endl;

    vector<vector<int>> dp(n,vector<int>(m,-1));
    cout << "LCSubsequence length = " << dplcs(n-1, m-1, s1, s2,dp) << endl;

    cout << "LCSubsequence length = " << tablcs(n, m, s1, s2) << endl;

    cout << "LCSubsequence length = " << space(n, m, s1, s2) << endl;
    return 0;
}
